...
//----------------------------------------------------------------------------------------------------------------------
	...
	public init( dx: Float=0.0, dy: Float=0.0, dz: Float=0.0 )
	{
		self.init(rows:
		[
	...
	public init( dx: Double=0.0, dy: Double=0.0, dz: Double=0.0 )
	{
...
//----------------------------------------------------------------------------------------------------------------------
	...
	public init( zoomx: Double, zoomy: Double )
	{
	...
	public init( flipHorizontally: Bool=false, flipVertically: Bool=false )
	{
...
//----------------------------------------------------------------------------------------------------------------------
	...
	public init( rotation: Double=0.0, axis: double3=double3(0.0,0.0,1.0) )
	{
	...
	public init( rotation: Float=0.0, axis: float3=float3(0.0,0.0,1.0) )
	{
